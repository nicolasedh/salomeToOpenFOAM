...
solidWall = geompy.CreateGroup(Partition_1, geompy.ShapeType["FACE"])
geompy.UnionIDs(solidWall, [52, 38, 48, 55, 58])
...
geompy.addToStudyInFather( Partition_1, solidWall, 'solidWall' )
...
solidWall_1 = Mesh_1.GroupOnGeom(solidWall,'solidWall',SMESH.FACE)
...
smesh.SetName(solidWall_1, 'solidWall')
